...
export default async function ProductDetail({ params }) {
  ...
  return (
    <>
      ...
      <div dangerouslySetInnerHTML={{ __html: html }} />
      {/* <section class='what-we-do product-specifications product-specifications-neww '>
                  ...
                  <div class='col-lg-12 col-md-12'>
                    <div>
                      <div class='product-specifications-grid'>
                        <div class='product-specifications-gridinner'>
                          <div class='main-heading'>
                            <h2 class='para text-center'>Material</h2>
                            <p class='smallpara text-center'>
                              Tinted mirror glass on aluminium or MDF backing
                            </p>
                          </div>
                        </div>
                        <div class='product-specifications-gridinner'>
                          <div class='main-heading'>
                            <h2 class='para text-center'>Mirror Options</h2>
                            <p class='smallpara text-center'>
                              Bronze, grey, black, smoked, antique finish
                            </p>
                          </div>
                        </div>
                        <div class='product-specifications-gridinner'>
                          <div class='main-heading'>
                            <h2 class='para text-center'>Glass Type</h2>
                            <p class='smallpara text-center'>
                              Toughened or laminated mirror (5mm–8mm)
                            </p>
                          </div>
                        </div>
                        <div class='product-specifications-gridinner'>
                          <div class='main-heading'>
                            <h2 class='para text-center'>Panel Height</h2>
                            <p class='smallpara text-center'>
                              Full-height (up to 10 ft or custom)
                            </p>
                          </div>
                        </div>
                        <div class='product-specifications-gridinner'>
                          <div class='main-heading'>
                            <h2 class='para text-center'>Fixing Options</h2>
                            <p class='smallpara text-center'>
                              Silicone bonded, concealed clips, grid layout, or
                        ...
                        <div class='product-specifications-gridinner'>
                          <div class='main-heading'>
                            <h2 class='para text-center'>Finish Types</h2>
                            <p class='smallpara text-center'>
                              Gloss polished, bevelled, etched or plain edge
                            </p>
                          </div>
                        </div>
                        <div class='product-specifications-gridinner'>
                          <div class='main-heading'>
                            <h2 class='para text-center'>Back Support</h2>
                            <p class='smallpara text-center'>
                              Aluminium framing or treated MDF wall base
                              (optional)
                            </p>
                          </div>
                        </div>
